...
struct DVL_
{
  ...
  _altitude_type altitude;
   ...
   typedef std::vector< ::uuv_sensor_ros_plugins_msgs::DVLBeam_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::uuv_sensor_ros_plugins_msgs::DVLBeam_<ContainerAllocator> >::other >  _beams_type;
  _beams_type beams;
